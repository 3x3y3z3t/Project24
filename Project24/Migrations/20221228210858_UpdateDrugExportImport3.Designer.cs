...
namespace Project24.Migrations
{
    ...
    [Migration("20221228210858_UpdateDrugExportImport3")]
    partial class UpdateDrugExportImport3
    {
            ...
            modelBuilder.Entity("Project24.Models.Internal.ClinicManager.DrugExportBatch", b =>
                {
                    ...
                    b.HasOne("Project24.Models.ClinicManager.TicketProfile", "Ticket")
                        .WithOne("DrugExportBatch")
                        .HasForeignKey("Project24.Models.Internal.ClinicManager.DrugExportBatch", "TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
