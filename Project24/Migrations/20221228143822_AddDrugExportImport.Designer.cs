...
namespace Project24.Migrations
{
    ...
    [Migration("20221228143822_AddDrugExportImport")]
    partial class AddDrugExportImport
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project24.Models.Internal.ClinicManager.DrugExportBatch", b =>
                {
                    ...
                    b.Property<string>("ExporterUserId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Project24.Models.Internal.ClinicManager.DrugImportBatch", b =>
                {
                    ...
                    b.Property<string>("ImporterUserId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("Project24.Models.Internal.ClinicManager.DrugExportBatch", b =>
                {
                    b.HasOne("Project24.Models.Identity.P24IdentityUser", "ExporterUser")
                        .WithMany()
                        .HasForeignKey("ExporterUserId");
                });
            ...
            modelBuilder.Entity("Project24.Models.Internal.ClinicManager.DrugImportBatch", b =>
                {
                    b.HasOne("Project24.Models.Identity.P24IdentityUser", "ImporterUser")
                        .WithMany()
                        .HasForeignKey("ImporterUserId");
                });
